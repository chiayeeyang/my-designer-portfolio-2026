...
export default function Home() {
 ...
 <section className="about" id="about"><div className="eyebrow">A LITTLE ABOUT ME</div><div><h2>Hi, I’m <i>Kristin.</i><br />Designer. Curious human.</h2><p>I'm a multidisciplinary designer with 6+ years of experience across visual, brand, and UI/UX design. I combine user research, visual systems, and strategic thinking to create intuitive experiences across advertising, hospitality, and healthcare.</p><p>I trained in graphic communication and found my way into the pastry kitchen, where I discovered that design and food are shaped by the same instinct — curating how people experience and interact with the world around them. I love using design — across taste, visuals, and technology — to create moments that connect people.</p><p>Outside of designing and baking, you'll find me on the couch, at a café, or out with friends, usually with good food nearby.</p><a className="text-link" href="/Kristin_Yang_Resume_Design.pdf" target="_blank" rel="noreferrer">View my résumé ↗</a></div></section>
