...
function CarouselPrevious({ className, variant = 'outline', size = 'icon-sm', ...props }) {
    ...
    return (<Button data-slot="carousel-previous" variant={variant} size={size} className={cn('rounded-full absolute touch-manipulation', orientation === 'horizontal'
...
function CarouselNext({ className, variant = 'outline', size = 'icon-sm', ...props }) {
    ...
    return (<Button data-slot="carousel-next" variant={variant} size={size} className={cn('rounded-full absolute touch-manipulation', orientation === 'horizontal'
