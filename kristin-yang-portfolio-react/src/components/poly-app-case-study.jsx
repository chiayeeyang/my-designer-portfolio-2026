...
export default function PolyAppCaseStudy() {
    ...
    <section id="app-outcome" className={styles.chapter}><div className="chapter-heading solution-chapter-heading"><span>03</span>Final outcome</div><p><strong>Case study update in progress</strong><br />This section is being updated with final designs and project reflections.</p></section></article></div>;
}
